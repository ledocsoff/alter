...
// Inline SVG icons — no dependencies, consistent rendering on all platforms
// All icons are 16x16 by default, stroked style
...
export const GripVerticalIcon = ({ size = 16, className = '' }) => (
